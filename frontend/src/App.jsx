...
import CategoryDetail from './assets/components/CategoryDetail/CategoryDetail'
  ...
  return (
    ...
    <Router>
        ...
        <Routes>
            ...
            <Route path='categories/:name' element={ <CategoryDetail designs={designs} loading={loading} empty={empty}/>} />
