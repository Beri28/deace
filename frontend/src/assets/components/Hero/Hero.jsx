        ...
        <div>
            ...
            <div className="hero-mobile d-lg-none shadow border rounded-3">
                    <div className="hero-overlay d-flex align-items-center position-relative">
                        <img src="/assets/img/img-12.png" className='position-absolute img-fluid custom-sticker shadow rounded-3' style={{top:"-4em",left:"8em",transform:"rotate(40deg)"}} alt="deco-1" />
                        <img src="/assets/img/img-10.png" className='position-absolute img-fluid custom-sticker custom-sticker-2 ct-3 shadow rounded-3' style={{top:"36em",left:"9em",transform:"rotate(320deg)"}} alt="deco-1" />
